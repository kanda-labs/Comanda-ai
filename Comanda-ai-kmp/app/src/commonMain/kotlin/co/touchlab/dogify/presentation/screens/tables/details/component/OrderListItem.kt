package co.touchlab.dogify.presentation.screens.tables.details.component
...
import co.touchlab.dogify.presentation.designSystem.components.ComandaAiListItem
import co.touchlab.dogify.presentation.designSystem.theme.ComandaAiTheme
import co.touchlab.dogify.presentation.screens.tables.details.OrdersDetailsItemState
    ...
    ComandaAiTheme {
        OrderListItem(
            order = OrdersDetailsItemState(
                ...
                status = co.touchlab.dogify.presentation.screens.tables.details.TableDetailsScreenBadge(
                    text = "Aberto",
